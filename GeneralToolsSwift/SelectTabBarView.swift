...
class SelectTabBarView: UIView
{
    ...
    func loadMainView()
    {
        ...
        fristBtu.loadHeadAndTitle(selectImage: "u21_down.png", normalImage: "u21.png", titleText: "逻辑处理");
        fristBtu.tag = 100;
        ...
        secondBtu.loadHeadAndTitle(selectImage: "u28_down.png", normalImage: "u28.png", titleText: "UI处理");
        secondBtu.tag = 101;
        ...
        threeBtu.loadHeadAndTitle(selectImage: "u32_down.png", normalImage: "u32.png", titleText: "混合处理");
        threeBtu.tag = 102;
